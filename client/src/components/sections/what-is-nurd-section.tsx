...
import nurdLogoLaptopImg from '@assets/4288A514-4A16-4431-944E-9130EC4BCC2F.png';
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="card-nurd border-t-[#22C55E] group">
            ...
            <h3 className="font-heading font-bold text-xl mb-3 bg-clip-text text-transparent bg-gradient-to-r from-black via-orange-500 to-amber-400">Creativity First</h3>
          ...
          <div className="card-nurd border-t-[#3B82F6] group">
            ...
            <h3 className="font-heading font-bold text-xl mb-3 bg-clip-text text-transparent bg-gradient-to-r from-black via-orange-500 to-amber-400">AI Collaboration</h3>
            <p className="text-gray-600 mb-4">
          ...
          <div className="card-nurd border-t-[#F97316] group">
            ...
            <h3 className="font-heading font-bold text-xl mb-3 bg-clip-text text-transparent bg-gradient-to-r from-black via-orange-500 to-amber-400">Community Building</h3>
            <p className="text-gray-600 mb-4">
