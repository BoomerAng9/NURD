...
export function AICourseCreator() {
  ...
  // Simulated course generation with delay
  const generateCourseMutation = useMutation({
    mutationFn: async (data: { 
      ...
      // Simulate an AI-generated course structure
      const mockCourse: AICreateCourseResponse = {
        title: data.type === 'topic' ? `Learn ${data.topic}` : 'Understanding Web Development',
        description: 'This comprehensive course covers all the essential concepts and practical implementations with hands-on examples and interactive exercises.',
        level: 'Beginner',
        category: data.type === 'topic' ? (data.topic || 'Programming').split(' ')[0] : 'Web Development',
        duration: data.courseLength === 'short' ? '2 hours' : data.courseLength === 'medium' ? '5 hours' : '10 hours',
        totalLessons: data.courseLength === 'short' ? 3 : data.courseLength === 'medium' ? 5 : 8,
        lessons: [
          {
            id: '1',
            title: 'Introduction and Core Concepts',
            description: 'Learn the foundational principles and core concepts needed to understand the subject matter.',
            content: 'This lesson introduces the fundamental concepts and provides an overview of what you will learn throughout the course.',
            duration: '30 mins',
            resources: [
              {
          ...
          },
          {
            ...
            description: 'Apply the concepts you learned in a practical, hands-on project.',
            content: 'This lesson guides you through creating your first project using the concepts we covered in the introduction.',
            duration: '45 mins',
            resources: [
              {
          ...
          },
          {
            ...
            description: 'Explore more complex techniques and patterns used by professionals.',
            content: 'In this lesson, we dive deeper into more advanced concepts and techniques that build upon the fundamentals.',
            duration: '60 mins',
            resources: [
              {
      ...
      // In a real implementation, the course would be generated by an AI service based on the input
