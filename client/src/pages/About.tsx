        ...
        <section className="py-16 bg-gradient-to-br from-[#121645] to-[#121645]/90 text-white">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-primary to-blue-600">About NURD</h1>
              <p className="text-xl leading-relaxed bg-clip-text text-transparent bg-gradient-to-r from-primary to-blue-600">
